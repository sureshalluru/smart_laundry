...
Connection strategy: open a fresh connection per Lambda invocation,
close it at the end. This avoids all stale-transaction issues on warm starts.
"""
import os
import psycopg2
...
def close():
    """Close the connection. Call this at the end of every Lambda invocation."""
    global _conn
    if _conn and not _conn.closed:
        try:
            _conn.close()
